...
| `Source/WebCore/PlatformShot.cmake` | macOS Shot 保留 `CoreVideoSoftLink.cpp` | CoreGraphics 静态图像与 IOSurface 路径仍调用 CVPixelBuffer API；保留系统框架软链接实现不启用视频播放链 | M4/macOS 🚧 已改，CI 验证中 |
