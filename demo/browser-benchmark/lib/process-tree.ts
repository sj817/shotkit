...
async function windowsTreeRSS(rootPID: number): Promise<number> {
...
async function unixTreeRSS(rootPID: number): Promise<number> {
...
export async function processTreeRSS(rootPID = process.pid): Promise<number> {
